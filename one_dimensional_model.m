 ...
 %
 % Edited by Meeta Cesler-Maloney: mvceslermaloney@alaska.edu
 % Version 1.6
...
% MVCM 03/23: added HT for horizontal transport rates
open_netcdf_output(model_path, NLEV, NTIM_CHEM, Times, BOX_WALL,...
    BOXCH, spec, spec_fixed, rates, VT, HT, depo, timeStrLen,...
...
% MVCM 03/23: added HT for horizontal transport rates and spec_bkg to hold the background column concentrations
[spec, spec_fixed, rates, VT, rate_constants] = ...
    integrate_model(model_path,NTIM_CHEM,NLEV,dt_chem,dt_kpp,Times,...
    temperature,pressure,relative_humidity,excoeff,jrates,spec_bkg,spec,spec_fixed,emissions,surface_source_emissions,rates,VT,HT,BOX_WALL,BOXCH,Kz,...
