...
function [spec, spec_fixed, rates, VT, HT, rate_constants] = integrate_model(...
    model_path,...
    NTIM_CHEM,...
    NLEV,...
    dt_chem,...
    ...
    if (run_vert_diff == 1) %if doing the vertical diffusion, do this
        ...
        for counter=1:1:diff_rep
            ...
            [spec(:,:,t+1), temp_VT(:,:), temp_HT(:,:), temp_depo(:,1), total_loss_to_ground(:,t+1)] = diffusion_1d (spec(:,:,t+1), spec_bkg(:,:,t+1), BOX_WALL, BOXCH, ...           
                ...
                rho, temperature, NLEV, dt_diff, Eff_dep_surf(:,t),  n_step_diff, total_loss_to_ground(:,t+1), run_chem, add_surface_source_HONO);
