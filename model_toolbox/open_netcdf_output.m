function open_netcdf_output(model_path,nlev,ntim,Times,BOX_WALL,BOXCH,...
    spec_conc,spec_conc_fixed,rates,VT,HT,depo,DateStrLen,...
...
open_vertical_transport_file (model_path, Times, nlev, ntim, DateStrLen, VT, HT, BOX_WALL, BOXCH, output_file_comment, output_file_created_by);
