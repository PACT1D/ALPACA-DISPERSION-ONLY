% MVCM 03/23: added a file to write for the horizontal transport rates and the concentration of species exported by horizontal advection
function write_netcdf_output(model_path,nlev,t,spec_conc,spec_conc_fixed,temperature,press,rh,rates,rate_constants,VT,HT,depo,addemissions, surface_source_emissions,...
...
%add add variable concentraiton species
for j=1:NVAR
  %size(spec_conc)
  %j
  %disp(spec_names{j});
...
% MVCM 03/23: horizontal transport rates here
%-%---------------------- write horizontal transport rates to netcdf file --------------------
ncid = netcdf.open([model_path '/output/ht_rates.nc'], 'WRITE');
