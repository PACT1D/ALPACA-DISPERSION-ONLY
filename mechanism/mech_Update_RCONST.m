...
% End INLINED RCONST                                               
   ...
   RCONST(424) = (2.50E-12*1.0) ;
   RCONST(425) = (aerosol_reaction_rates(1,TIME,GStruct)) ;
   RCONST(426) = (aerosol_reaction_rates(2,TIME,GStruct)) ;
   RCONST(427) = (aerosol_reaction_rates(3,TIME,GStruct)) ;
   RCONST(428) = (aerosol_reaction_rates(4,TIME,GStruct)) ;
   RCONST(429) = (aerosol_reaction_rates(5,TIME,GStruct)) ;
   RCONST(430) = (aerosol_reaction_rates(6,TIME,GStruct)) ;
   RCONST(431) = (aerosol_reaction_rates(7,TIME,GStruct)) ;
   RCONST(432) = (aerosol_reaction_rates(8,TIME,GStruct)) ;
   RCONST(433) = (GStruct.xCl*aerosol_reaction_rates(9,TIME,GStruct)) ;
   RCONST(434) = (GStruct.xCl*aerosol_reaction_rates(10,TIME,GStruct)) ;
   RCONST(435) = (GStruct.xCl*aerosol_reaction_rates(11,TIME,GStruct)) ;
   RCONST(436) = (GStruct.xCl*aerosol_reaction_rates(12,TIME,GStruct)) ;
   RCONST(437) = (GStruct.xCl*aerosol_reaction_rates(13,TIME,GStruct)) ;
   RCONST(438) = (GStruct.xCl*aerosol_reaction_rates(14,TIME,GStruct)) ;
   RCONST = RCONST(:);
...
%       (http://www.cs.vt.edu/~asandu/Software/KPP)                
   %KPPisdistributedunderGPL,thegeneralpubliclicence%(http://www.gnu.org/copyleft/gpl.html)
